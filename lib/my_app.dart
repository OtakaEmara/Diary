...
import 'features/write_notes/logic/cubit/write_notes_states.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => WriteNotesCubit()..createNotes(),
      child: BlocConsumer<WriteNotesCubit, WriteNotesStates>(
